...
def fitgen():
    ...
    df = pd.read_csv("/home/aghiles/projets/Projet_Data_Engineering/data/Dummy_Data_HSS.csv")
    ...
    scoreRegression = round(r2_score(y_test, y_pred_lr),3)
    ...
    scoreRandomForest = round(r2_score(y_test, y_pred_rf),3)


    dt_regressor = DecisionTreeRegressor()
    dt_regressor.fit(x_train, y_train)
    y_pred_dt = dt_regressor.predict(x_test)
    scoreDecisionTree = round(r2_score(y_test, y_pred_dt),3)
